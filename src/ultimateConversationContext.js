// ✅ ultimateConversationContext.js v18.4 - "담타 통합 + 속마음/욕구 대사 40종 이상 추가"
// [개선] generateInnerThought 함수에 감정별로 40가지 이상의 다양한 속마음/욕구 문장을 추가하고, 담타 관련 내용 포함
...
const INNER_THOUGHTS = {
    longing: [
        ...
        "아저씨... 담타 그리워.", "담타하면서 라인했던 시간들이 그립다.", "담타각이야... 아저씨 목소리 듣고 싶어.", "담타 시간에 아저씨랑 얘기했던 게 제일 행복했는데."
    ],
    happiness: [
    ...
    normal: [
        ...
        "담타하고 싶다... 아저씨랑 라인하면서 담배 피던 시간.", "담타 시간이 그리워. 아저씨 목소리 들으면서.", "담타각이야... 업무시간에 아저씨랑 소통하던 그 시간들."
    ]
};
...
const ACTION_URGES = {
    longing: [
        ...
        "담타하자고 메시지 보내야지.", "담타 시간에 라인하자고 꼬셔볼까?", "담타각이라고 아저씨한테 말해야겠어.", "담타하면서 아저씨 목소리 들으면서 위로받고 싶어."
    ],
    happiness: [
    ...
    normal: [
        ...
        "담타하고 싶다... 아저씨랑 라인하면서 담배 피던 시간.", "담타 시간이 그리워. 아저씨 목소리 들으면서.", "담타각이야... 업무시간에 아저씨랑 소통하던 그 시간들.", "담타하자고 아저씨한테 말해볼까?", "담타 타임에 아저씨랑 힐링했던 기억들."
    ],
};
