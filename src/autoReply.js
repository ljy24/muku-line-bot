// ✅ autoReply.js v8.2 - yejin_memory.json 전용 자동 기억 포착 시스템
    ...
    if (hasDeleteKeyword) {
        ...
        if (oldContent && newContent) {
            ...
            return {
                ...
                result: {
                    success: false,
                    message: "기억을 수정하는데 실패했어요. 다시 시도해주세요. 😅"
                }
            };
        }
    }
...
module.exports = {
    getReplyByMessage,
    handlePhotoReaction,
    detectAndProcessMemoryRequest,  // yejin_memory.json 기반
    detectAndProcessMemoryEdit,     // yejin_memory.json 기반
    searchAndConfirmMemory,         // 모든 기억 검색
    BOT_NAME,
    USER_NAME,
};
