...
async function initializeSpontaneousPhoto(modules, client) {
    ...
    if (modules.spontaneousPhotoManager && modules.spontaneousPhotoManager.startSpontaneousPhotoScheduler) {
        try {
            ...
            // ▼▼▼ 수정된 부분 2: await 추가 ▼▼▼
            await modules.spontaneousPhotoManager.startSpontaneousPhotoScheduler(client, userId, getLastUserMessageTime);
