// src/autoReply.js - v2.6 (기분 시스템: 걱정함, 사랑함, 화남, 불안함 추가 및 5분 주기 로그 추가)
...
setInterval(() => {
    ...
    // getCurrentMoodStatus() 함수가 이미 내부적으로 콘솔 로그를 포함합니다.
    // 이 로그는 현재 예진이의 기분, 생리 상태, 마지막 메시지 시간 등을 포함합니다.
    getCurrentMoodStatus(); 
    console.log(`========================================================\n`);
}, 5 * 60 * 1000); // 5분 = 5 * 60초 * 1000밀리초
