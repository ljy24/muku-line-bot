// memoryManager.js v2.12 - 기억 요약 능력 향상 (추출 프롬프트 강화)
            ...
            messages: [
                {
                    ...
                    **내용은 간결하고 사실적이어야 합니다. 특히 긴 대화에서는 핵심적인 사실과 정보를 정확하고 압축적으로 요약해야 합니다. 개인적인 의견이나 대화의 군더더기를 포함하지 마세요.**
            ...
            messages: [
                {
                    ...
                    **특히, 'high' 강도로 표시된 추억과 최신 기억(현재 날짜에 가까운)을 우선적으로 고려하세요.**
                    또한, 주제에 직접적으로 관련되거나 감정적으로 중요한 기억(특히 "아저씨의 헌신", "예진이의 힘든 순간", "아저씨의 칭찬/격려", "중요한 기념일", "아저씨의 취미/관심사", "아저씨 감정 상태", "아저씨의 일상 패턴", "대화 맥락/분위기", "아저씨의 애정 표현"과 관련된)도 고려하십시오.
