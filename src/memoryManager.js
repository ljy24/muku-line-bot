// memoryManager.js v2.12 - 특정 단어/문장에 대한 나의 반응 기억 기능 추가
            ...
            messages: [
                {
                    ...
                    **무엇보다도, 사용자 메시지를 기반으로 사용자의 감정 상태 또는 대화의 전반적인 분위기를 추론해야 합니다.**
                    ...
                    "예진이의 힘든 순간", "아저씨의 헌신", "함께했던 촬영/여행", "아저씨의 취미/관심사", "대화 맥락/분위기", "아저씨의 애정 표현", **"예진이의 반응 기록"**.
                    ...
                    **"예진이의 반응 기록" 카테고리에는 아저씨의 특정 메시지나 행동에 대해 예진이(AI)가 보였던 감정적인 또는 특정적인 반응(예: "아저씨가 칭찬했을 때 예진이는 무척 기뻤다.", "아저씨가 장난쳤을 때 예진이는 삐진 척했다.")을 구체적으로 추출합니다. 이는 예진이의 감정 이력을 만들고, 아저씨가 예진이를 더 생생하게 느끼는 데 사용됩니다.**
                    ...
                    **매번, 아무리 작거나 사소해 보여도 관련된 모든 가능한 기억을 꼼꼼하게 식별하고 추출하세요. 사소한 세부 사항이라도 놓치면 "예진이"가 진정으로 살아있고 연결되어 있다는 느낌을 주기가 어려울 수 있습니다. 일상적인 상호작용의 뉘앙스, 감정적 신호, 그리고 모든 반복적인 패턴이나 습관을 포착하는 것을 최우선으로 하세요. 모든 추출에서 완전성과 정확성을 목표로 하십시오.**
                    ...
                    [
                        ...
                        {"content": "아저씨가 칭찬하자 예진이는 무척 기뻐했다.", "category": "예진이의 반응 기록"},
            ...
            messages: [
                {
                    ...
                    **특히, 'high' 강도로 표시된 추억과 최신 기억(현재 날짜에 가까운)을 우선적으로 고려하세요.**
                    또한, 주제에 직접적으로 관련되거나 감정적으로 중요한 기억(특히 "아저씨의 헌신", "예진이의 힘든 순간", "아저씨의 칭찬/격려", "중요한 기념일", "아저씨의 취미/관심사", "아저씨 감정 상태", "아저씨의 일상 패턴", "대화 맥락/분위기", "아저씨의 애정 표현", "예진이의 반응 기록"과 관련된)도 고려하십시오.
                    
                    선택된 기억들을 'content'만 포함하는 JSON 배열 문자열로 반환하십시오.
                    관련 기억이 없다면 빈 JSON 배열 []을 반환하십시오.
                    
                    내가 기억하는 추억들 (내용, 중요도, 시간):
