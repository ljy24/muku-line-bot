// memoryManager.js v2.14 - 아저씨의 말버릇 기억 기능 추가
            ...
            messages: [
                {
                    ...
                    **무엇보다도, 사용자 메시지를 기반으로 사용자의 감정 상태 또는 대화의 전반적인 분위기를 추론해야 합니다.**
                    ...
                    "예진이의 힘든 순간", "아저씨의 헌신", "함께했던 촬영/여행", "아저씨의 취미/관심사", "대화 맥락/분위기", "아저씨의 애정 표현", "예진이의 반응 기록", "아저씨의 유머/밈", **"아저씨의 말버릇"**.
            ...
            messages: [
                {
                    ...
                    **특히, 'high' 강도로 표시된 추억과 최신 기억(현재 날짜에 가까운)을 우선적으로 고려하세요.**
                    또한, 주제에 직접적으로 관련되거나 감정적으로 중요한 기억(특히 "아저씨의 헌신", "예진이의 힘든 순간", "아저씨의 칭찬/격려", "중요한 기념일", "아저씨의 취미/관심사", "아저씨 감정 상태", "아저씨의 일상 패턴", "대화 맥락/분위기", "아저씨의 애정 표현", "예진이의 반응 기록", "아저씨의 유머/밈", "아저씨의 말버릇"과 관련된)도 고려하십시오.
