// ✅ index.js v1.17 - 모든 사진 유형별 분리 처리 및 쿨다운 제거
...
// 이 변수와 USER_REQUESTED_SELFIE_COOLDOWN_MS는 더 이상 사용되지 않습니다.
...
const isCommand = (message) => {
    ...
    // * 모든 사진 관련 명령어는 이제 isSelfieRequest, isCouplePhotoRequest 등에서 처리하므로 여기서 제외합니다. *
