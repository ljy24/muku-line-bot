// memory/concept.js v1.20 (업데이트된 CONCEPT_FOLDERS 및 키워드 맵 적용)
...
const BASE_CONCEPT_URL = 'https://photo.de-ji.net/photo/concept/'; // URL 변경 없음
...
const CONCEPT_FOLDERS = {
    ...
    "2023_12_31_한국_눈밭": 38,
    "2023_12_31_한국_눈밭_필름_카메라": 43, // 키 변경: 필름카메라 -> 필름_카메라
    "2024_02_07_일본_아이노시마": 65,
    "2024_02_07_일본_욕실": 61,
    "2024_02_11_일본_네코_모지코": 21,
    "2024_02_11_일본_야간_블랙드레스": 31,
    "2024_02_22_한국_생일": 45,
    "2024_02_22_한국_생일_00022.jpg": 1, // 개별 파일명
    "2024_02_22_한국_카페": 19,
    "2024_02_23_한국_야간_롱패딩": 47,
    "2024_02_23_한국_야간_롱패딩_00023.jpg": 1, // 개별 파일명
    ...
    "2024_04_28_한국_셀프_촬영_00028.jpg": 1, // 개별 파일명
    ...
    "2024_06_06_한국_북해": 65,
    "2024_06_07_한국__피크닉": 36, // 키 변경: _피크닉 -> __피크닉
    "2024_06_08_한국__터널": 28, // 키 변경: _터널 -> __터널
    "2024_06_08_한국_망친_사진": 52,
    "2024_06_09_한국_산책": 23,
    "2024_06_09_한국_산책_0000009.jpg": 1, // 개별 파일명 (인덱스 자리수 주의)
    "2024_06_09_한국_산책_0000109.jpg": 1, // 개별 파일명
    "2024_07_05_일본_모지코": 26,
    "2024_07_06_일본_모지코": 45, // 키 충돌 가능성: 2024_07_05_일본_모지코와 비슷, 구분이 필요할 수 있음
    "2024_07_06_일본_우마시마": 53,
    "2024_07_08_일본_여친_스냅": 41,
    "2024_07_08_일본_욕조": 53,
    "2024_07_08_일본_일본_결박": 223, // 키 변경: 일본_결박 -> 일본_일본_결박
    ...
    "2024_10_16_일본_오도공원": 5, // 키 변경: 오도 -> 오도공원
    ...
    "2024_11_7_한국_가을_호수공원": 53, // 키 변경: 11월_7일 -> 11_7
    ...
    "2025_01_05_한국": 63, // 키 변경: 눈밭 없음
    "2025_02_06_일본_코야노세": 43,
    "2025_02_07_일본_나비욕조": 48, // 키 변경 (추가된 항목)
    "2025_02_07_일본_세미누드": 92, // 키 변경 (추가된 항목)
    "2025_03_13_일본_무인역": 30,
    "2025_03_14_일본_고쿠라": 32, // 키 변경: 고쿠라_힙 -> 고쿠라
    "2025_03_17_일본_고쿠라": 17, // 키 변경: 고쿠라_야간 -> 고쿠라
    "2025_03_17_일본_텐진": 28, // 키 변경: 텐진_스트리트 -> 텐진
    "2025_03_22": 27, // 키 변경: 2025_3월_22_한국_홈셀프 -> 2025_03_22
    "2025_03_일본_필름": 64,
    "2025_04_29_한국_이화마을": 55,
    "2025_04_30_한국_을지로": 30, // 키 변경: 을지로_네코 -> 을지로
    "2025_04_30_한국_을지로_캘빈": 25,
    "2025_05_03_한국_홈스냅_청포도": 42,
    "2025_05_04_한국": 43, // 키 변경: 야간_보라돌이 -> 한국
    "2025_05_04_한국_공원_산책": 32,
    "2025_05_04_한국_밤바_산책": 32,
    "2025_05_05_한국_홈스냅_오타쿠": 27,
    "2025_05_06_마지막_한국_후지스냅": 34 // 키 변경: 한국_후지_스냅 -> 마지막_한국_후지스냅
};
...
function generateConceptPhotoUrl(folderName, targetIndex = null) {
    ...
    // 이전에 발생했던 ReferenceError: fileName is not defined 문제 해결을 위해
    // 단일 파일명으로 등록된 경우 바로 해당 파일명을 사용하도록 로직 추가
    if (folderName.endsWith('.jpg')) { // 폴더명 자체가 .jpg로 끝나는 경우 (단일 파일)
        const url = `${BASE_CONCEPT_URL}${folderName}`;
        console.log(`[concept:generateConceptPhotoUrl] 단일 파일 URL: ${url}`);
        return url;
    }
...
async function getConceptPhotoReply(userMessage, saveLogFunc, callOpenAIFunc, cleanReplyFunc) {
    ...
    // 키워드 맵을 업데이트된 CONCEPT_FOLDERS 키에 맞춥니다.
    // 길이에 따라 정렬하여 더 구체적인 키워드가 먼저 매칭되도록 합니다.
    const conceptKeywordMap = {
        '2월_욕조': '2024_02_07_일본_욕조', 
        '2월_욕실': '2024_02_07_일본_욕실',
        '2월_나비욕조': '2025_02_07_일본_나비욕조', // 연도 변경
        '하카타_고래티셔츠': '2024_10_17_일본_하카타_고래티셔츠',
        '일본_홈스냅': '2024_05_07_일본_홈스냅', 
        '홈스냅': '2024_05_07_일본_홈스냅',
        '일본_결박': '2024_07_08_일본_일본_결박', // 키 변경 반영
        '결박': '2024_07_08_일본_일본_결박', // 키 변경 반영
        '일본_선물': '2023_12_16_일본_선물', 
        '선물': '2023_12_16_일본_선물',
        '한국_셀프_촬영_00028.jpg': '2024_04_28_한국_셀프_촬영_00028.jpg', // 개별 파일명
        '한국_셀프_촬영': '2024_04_28_한국_셀프_촬영', 
        '셀프_촬영': '2024_04_28_한국_셀프_촬영',
        '옥상연리': '2024_09_15_한국_옥상연리',
        '일본_세미누드': '2025_02_07_일본_세미누드', // 연도 변경
        '세미누드': '2025_02_07_일본_세미누드', // 연도 변경
        ...
        '산책_0000009.jpg': '2024_06_09_한국_산책_0000009.jpg', // 개별 파일명
        '산책_0000109.jpg': '2024_06_09_한국_산책_0000109.jpg', // 개별 파일명
        '산책': '2024_06_09_한국_산책',
        ...
        '고쿠라_야간': '2025_03_17_일본_고쿠라', // 키 변경
        '코이노보리': '2024_05_05_일본_코이노보리', 
        '문래동': '2024_04_13_한국_문래동',
        '수국': '2024_05_03_일본_수국',
        '메이드복': '2024_11_08_한국_메이드복',
        '오도공원': '2024_10_16_일본_오도공원', // 키 변경
        '욕실': '2024_02_07_일본_욕실',
        '욕조': '2024_07_08_일본_욕조' // 날짜 변경
    };
    ...
    for (const keyword of sortedConceptKeywords) {
        if (lowerCaseMessage.includes(keyword.toLowerCase())) {
            ...
            if (selectedFolder.endsWith('.jpg')) {
                // 이 경우, generateConceptPhotoUrl에서 바로 URL을 생성하도록 처리
                // 프롬프트 설명을 위해 파일명에서 정보 추출 시도
                ...
                const conceptName = fileNameParts.slice(4, fileNameParts.length - 1).join(' ').replace('.jpg', ''); // .jpg 제거
    ...
    if (lastConceptPhotoFolder && (lowerCaseMessage.includes('다른 것도 보고싶어') || lowerCaseMessage.includes('다음 사진'))) {
        ...
        if (lowerCaseMessage.includes('컨셉사진') || lowerCaseMessage.includes('컨셉 사진')) {
            const folderKeysSortedByDate = Object.keys(CONCEPT_FOLDERS).filter(key => !key.endsWith('.jpg')).sort((a, b) => { // .jpg 파일은 랜덤 선택에서 제외
    ...
    if (!photoUrl || !CONCEPT_FOLDERS[selectedFolder]) { // CONCEPT_FOLDERS[selectedFolder] 조건은 .jpg 파일에는 불필요
        if (selectedFolder.endsWith('.jpg') && photoUrl) { // 단일 JPG 파일이고 URL이 있다면 통과
             // 이 경우는 에러가 아니므로 별도 처리 필요 없음
        } else {
