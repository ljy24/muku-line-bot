...
const PHOTO_FOLDERS = {
   'couple': 292,
    ...
    '추억_24_01_한국_신년파티': 42,
    '추억_24_01_한국': 210,
    '추억_24_01_21_함께_출사': 56,
    '추억_24_02_일본_후지': 261,
    '추억_24_02_일본': 128,
    '추억_24_02_한국_후지': 33,
    '추억_24_02_한국': 141,
    '추억_24_02_25_한국_커플사진': 86,
    '추억_24_03_일본_스냅_셀렉전': 318,
    '추억_24_03_일본_후지': 226,
    '추억_24_03_일본': 207,
    '추억_24_04_출사_봄_데이트_일본': 90,
    '추억_24_04_출사_봄_데이트_한국': 31,
    '추억_24_04_한국': 379,
    '추억_24_05_일본_후지': 135,
    '추억_24_05_일본': 301,
    '추억_24_06_한국': 146,
...
async function getOmoideReply(userMessage, saveLogFunc, callOpenAI, cleanReply) {
    ...
    if (lowerCaseMessage.includes('무쿠 셀카') || lowerCaseMessage.includes('애기 셀카')) {
        ...
        if (candidateFolders.length > 0) {
            ...
            promptSuffix = photoFoundMessage;
        } else {
